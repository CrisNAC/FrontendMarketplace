...
export default function DetalleProducto() {
  ...
  return (
    <div className="h-screen bg-[#F3F3F3] overflow-hidden">
      <div className="max-w-6xl mx-auto h-full px-12 py-4 flex flex-col justify-between">

        {/* header boton */}
        <button type="button" className="flex items-center gap-3 w-fit">
        ...
        <div className="grid grid-cols-2 gap-16 items-center flex-1">
          ...
          <div className="flex flex-col items-start">
            ...
            {/* caracterisitcas*/}
            <div className="mt-4">
              <h3 className="text-[13px] font-semibold mb-1 text-black">
                Características
              </h3>
              <ul className="text-[12px] text-black list-disc list-outside pl-5 space-y-[2px]">
                  ...
                  return (
                    <button
                      ...
                      className={`w-9 h-9 rounded-full flex items-center justify-center transition
                        ${activo ? "ring-2 ring-black" : "border border-gray-300 hover:border-black"}
                      `}
            ...
            <div className="mt-4">
              <h3 className="text-[13px] font-semibold mb-1 text-black">
                Memoria Interna{" "}
                <span className="text-gray-500 font-normal">{memoria}</span>
              </h3>
        ...
        <div className="flex items-center justify-between mt-2">
          ...
          <div className="flex items-center gap-4">
            ...
            >
              <SvgIcon
                className={`w-5 h-5 ${favorito ? "text-red-500" : "text-gray-600"}`}
              >
                {I.heart}
              </SvgIcon>
            </button>
